...
public class LoginScreen implements Screen {
    ...
    /**
     * @param game
     *  creates a login page that executes the game after a login
     */
    ...
    private void btnLoginClicked() {
        ...
        try {
            Player player = HttpRequestHandler.printSendGet("Users/" + txfUsername.getText() + "/" + txfPassword.getText());
            if(player == null)
    ...
    /**
     * shows new account page when clicked
     */
