...
public class NewAccountScreen implements Screen {
    ...
    /**
     * @throws Exception
     * handles button click to create a new account
     */
...
//        rs.sendLogin(txfUsername.toString());
        User user = new User();
        user.setName(txfUsername.getText());
        user.setPassword(txfPassword.getText());
        boolean created = HttpRequestHandler.sendPost("Users/Create", user);
        if(created) {
